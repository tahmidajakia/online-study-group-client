...
const Navbar = () => {
  ...
  <input onChange={handleTheme} type="checkbox" checked={theme === "light" ? false : true } value="dark"  className="toggle theme-controller bg-base-content row-start-1 col-start-1 col-span-2"/>
